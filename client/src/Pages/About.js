...
const blogs = [
  {
    ...
    text: 'In bustling Delhi, a college student named Pankaj faced daily commuting struggles. Determined to find an efficient solution, he founded E2EM (End to End Mobility). Inspired...'
  },
  {
    src: TELECOM,
