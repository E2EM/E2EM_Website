            ...
            <div className='footer-cont '>
                <div className='footer row'>
                    ...
                    <div className='footer-query col-md-2 col-sm-4'>
                        ...
                        <FontAwesomeIcon className='footer-icon' icon="fa-brands fa-instagram" size='xl' />
                        <FontAwesomeIcon className='footer-icon' icon="fa-brands fa-facebook" size='xl' /> 
                        <FontAwesomeIcon className='footer-icon' icon="fa-brands fa-twitter" size='xl' />
                        </div>
                    {/* </div> */}
